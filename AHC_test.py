...
print(np.corrcoef(gini_list, frustation_list))
print('\n')
print('Pearson correlation coefficients between gini and balance index index: ')
print(np.corrcoef(gini_list, balance_list))